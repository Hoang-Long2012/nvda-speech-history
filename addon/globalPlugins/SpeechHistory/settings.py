...
from .constants import (CONFIG_SECTION, MIN_HISTORY_ENTRIES, MAX_HISTORY_ENTRIES, POST_COPY_BEEP, POST_COPY_SPEAK, POST_COPY_BOTH, DEFAULT_POST_COPY_ACTION, MIN_BEEP_FREQUENCY, MAX_BEEP_FREQUENCY, MIN_BEEP_DURATION, MAX_BEEP_DURATION)
